...
class TestApp(unittest.TestCase):
    ...
    def test_save_hvac_to_database(self):
        ...
        self.app.save_event_to_database("2024-01-01", float(self.app.T_MIN), "Activating Heater for 10 ticks")
        self.app.get_connection.return_value.cursor.return_value.execute.assert_called_with('INSERT INTO events (event, "createdAt") VALUES (%s, %s)', ("Activating Heater for 10 ticks", "2024-01-01"))
        ...
        self.app.get_connection.return_value.cursor.return_value.execute.assert_called_with('INSERT INTO temperatures (temperature, "createdAt") VALUES (%s, %s)', (20.0, "2024-01-01"))
        ...
        self.app.save_event_to_database("2024-01-01", float(self.app.T_MAX), "Activating AC for 10 ticks")
        ...
        self.app.save_event_to_database("2024-01-01", float(self.app.T_MAX) + 1, "Activating AC for 10 ticks")
        self.app.get_connection.return_value.cursor.return_value.execute.assert_called_with('INSERT INTO events (event, "createdAt") VALUES (%s, %s)', ("Activating AC for 10 ticks", "2024-01-01"))